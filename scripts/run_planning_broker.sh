...
args=(
  --name planning
  --inbox /memories/repo/agent-handoff-log.md
  --outbox /memories/repo/next-agent-ticket.md
  --poll-seconds "${BROKER_POLL_SECONDS:-30}"
  --state-file "${BROKER_STATE_FILE:-$REPO_ROOT/.cache/agent-brokers/planning.json}"
)
